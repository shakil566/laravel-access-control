                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul class="collapse {{ Route::is('admin.product.create') || Route::is('admin.product.index') || Route::is('admin.product.edit') || Route::is('admin.product.show') ? 'in' : '' }}">
                            @if ($usr->can('product.view'))
                                <li class="{{ Route::is('admin.product.index')  || Route::is('admin.product.edit') ? 'active' : '' }}"><a href="{{ route('admin.product.index') }}">All Product</a></li>
                            @endif
                            @if ($usr->can('product.create'))
                                <li class="{{ Route::is('admin.product.create')  ? 'active' : '' }}"><a href="{{ route('admin.product.create') }}">Create Product</a></li>
                            @endif
                        </ul>
                    </li>
                    @endif
