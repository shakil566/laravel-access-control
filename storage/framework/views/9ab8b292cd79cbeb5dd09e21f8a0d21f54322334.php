            ...
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul class="collapse <?php echo e(Route::is('admin.product.create') || Route::is('admin.product.index') || Route::is('admin.product.edit') || Route::is('admin.product.show') ? 'in' : ''); ?>">
                            <?php if($usr->can('product.view')): ?>
                                <li class="<?php echo e(Route::is('admin.product.index')  || Route::is('admin.product.edit') ? 'active' : ''); ?>"><a href="<?php echo e(route('admin.product.index')); ?>">All Product</a></li>
                            <?php endif; ?>
                            <?php if($usr->can('product.create')): ?>
                                <li class="<?php echo e(Route::is('admin.product.create')  ? 'active' : ''); ?>"><a href="<?php echo e(route('admin.product.create')); ?>">Create Product</a></li>
                            <?php endif; ?>
                        </ul>
                    </li>
                    <?php endif; ?>
...
<?php /**PATH F:\xampp\htdocs\laravel-access-control\resources\views/backend/layouts/partials/sidebar.blade.php ENDPATH**/ ?>